...
I initially visualised the data as a stacked bar chart with the female frequency bar on top of the male frequency bar. This bar chart made it difficult to determine the numbers of female suspects since they are so small compared to the male suspects. 
...
# Save the bar chart
ggsave(here("Visualisations", "bar_chart.png"), width = 12, height = 8)
```
#### Initial Visualisation
![](./Visualisations/bar_chart.png)
The above function was used to include the graphs in the published GitHub webpage.

To aid visualisation, I then chose a line graph to look at female suspects compared to male suspects. 
...
ggsave(here("Visualisations", "line_graph.png"), plot = plot, width = 12, height = 8)
```

#### Improved Visualisation - Line Graph

![](./Visualisations/line_graph.png)
### Animated line graph - plot for assessment

To be able to visualise the progression of the homicide suspects over the years, I decided to animate the line graph. This is the plot I submitted for assessment.

```{r Animate the plot, warning=FALSE, message=FALSE}
...
# Save the plot as a gif for assessment
if(knitr::is_html_output()){
  anim_save(here("Visualisations" , "final_graph.gif"), animated, renderer = gifski_renderer())
}
```
#### Visualisation for Assesment - Animated Line Graph
![](./Visualisations/final_graph.gif)
# Conclusions
