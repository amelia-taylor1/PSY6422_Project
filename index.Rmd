...
# Need to install and load the necessary packages
...
Additionally, if I had more time, I would also slant the x axis labels in the animated line graph as they are in the stacked bar chart. I included the 'angle = 45' initially in the code for the animated line graph but it would not work.
